    ...
    <div className="min-h-screen">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            We are the collective voice of petroleum dealers and tank owners
            across the Kashmir Valley. We protect dealer rights, promote fair
            trade, and ensure that this industry stays strong, local, and ready
            for the future.
          </motion.p>
        </div>
      </motion.section>
              ...
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-slate-600">
                    Add dealers, employees, and clients to the unified registry
                    system with comprehensive tracking.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-slate-600">
                    Quickly find employment history, client assignments, and
                    vehicle registrations across the valley.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-slate-600">
                    Handle client transfers between dealers with proper
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            >
              {[
                {
                  name: "Haji Ghulam Mohi Ud Din Rafiquee",
                  title: "Founding President",
                },
                { name: "Haji Abdul Ahad Pandit", title: "Past President" },
                {
                  name: "Haji Mushtaq Ahmed Rafiquee",
          ...
          <div>
            ...
            >
              {[
                {
                  name: "Er. Javed Ahmed Ashai",
                  title: "President",
                  icon: Crown,
                  color: "bg-primary",
                },
                {
                  name: "Mr. Mohammad Shafi Khanday",
                  title: "General Secretary",
                  icon: ClipboardList,
                  color: "bg-secondary",
                },
                {
                  name: "Mr. Majid Mushtaq Rafiquee",
                  title: "Vice President",
                  icon: UserCheck,
                  color: "bg-accent",
                },
                {
                  name: "Mr. Mohd Altaf Pandit",
                  title: "Secretary",
                  icon: FileText,
                  color: "bg-neutral",
                },
                ...
                <motion.div key={index} variants={fadeInUp}>
                  <Card>
                    <CardContent className="p-6 text-center">
                      <div
                        className={`w-20 h-20 ${leader.color} rounded-full mx-auto mb-4 flex items-center justify-center`}
                      >
                      ...
                      <p
                        className={`text-sm font-medium ${
                          leader.color === "bg-primary"
                            ? "text-primary"
                            : leader.color === "bg-secondary"
                              ? "text-secondary"
                              : leader.color === "bg-accent"
                                ? "text-accent"
                                : "text-neutral"
                        }`}
                      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
              Our foundation was laid by Late Haji Ghulam Mohi-ud-din Rafiquee
              Sahib, unanimously elected lifelong President. Official
              registration and bye-laws were undertaken by Mohammed Shafi
              Khanday with support from the founding members.
            </p>
